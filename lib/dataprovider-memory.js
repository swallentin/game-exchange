...
DataProvider.prototype.findByTitel = function(titel, callback) {
  var result = null;
...
DataProvider.prototype.findById = function(id, callback) {
  ...
  if(result == null) {
    callback(new Error('Could not find item by id. Item does not exist.'), item);
    return;
  }
...
DataProvider.prototype.deleteById = function(id, callback) {
  ...
  if(result == null) {
    callback(new Error('Item does not exist.'), result);
    return;
  }
